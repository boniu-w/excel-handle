...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		// 配置不会被拦截的链接 顺序判断
		filterChainDefinitionMap.put("/app/appController/excelUtilTest", "anon"); // 导出接口排除
		filterChainDefinitionMap.put("/app/appController/export2", "anon"); // 导出接口排除
		filterChainDefinitionMap.put("/app/appController/exportExcel", "anon"); // 导出借口排除
